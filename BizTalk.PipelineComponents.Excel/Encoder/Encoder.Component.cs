...
namespace BizTalk.PipelineComponents.Excel
{
    public partial class Encoder : IPersistPropertyBag
    {
        ...
        {
            classID = new Guid("b46b052c-c482-4434-9a6e-d49654852339");
        }
        ...
        public void Load(IPropertyBag propertyBag, int errorLog)
        {
            ...
            XLSOutput = BizTalkComponents.Utils.PropertyBagHelper.ReadPropertyBag<bool>(propertyBag, "XLSOutput", XLSOutput);

            ExcelTemplate = BizTalkComponents.Utils.PropertyBagHelper.ReadPropertyBag<string>(propertyBag, "ExcelTemplate", ExcelTemplate);
        ...
        public void Save(IPropertyBag propertyBag, bool clearDirty, bool saveAllProperties)
        {
            if (DocumentSpecName != null)
                ...
                BizTalkComponents.Utils.PropertyBagHelper.WritePropertyBag(propertyBag, "XLSOutput", XLSOutput);
      
                BizTalkComponents.Utils.PropertyBagHelper.WritePropertyBag(propertyBag, "ExcelTemplate", ExcelTemplate);
